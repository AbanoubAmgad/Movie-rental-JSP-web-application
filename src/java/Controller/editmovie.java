    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (!valid) {
                ...
                out.println("This is Not a Valid Quality");
                out.println("<button onclick=\"goBack()\">Go Back</button>");
                out.println("<script>");
                out.println("function goBack() {window.history.back()}");
                out.println("</script>");
                ...
                try {
                    ...
                    Stmt.executeUpdate("Update movies set releasedate = '" + movie.getReleasedate()
                            + "',genre = '" + movie.getGenre() + "', description = '" + movie.getDescription() + "', actors = '"
                            + movie.getActors() + "',quantity = '" + movie.getQuantity() + "',price = '" + movie.getPrice() + "' where name = '" + movie.getName() + "'");
